...
describe("buildInviteEmail", () => {
  ...
  it("identifies the course as an STSA Church course", () => {
    ...
    expect(email.html).toContain("Bring an ancient faith to your modern world.");
  ...
  it("uses plural wording and escapes HTML for several courses", () => {
    const multi = buildInviteEmail({ courseTitles: ["A <b>", "B"], trainingUrl: "https://x.test/training", invitedByName: "S" });
